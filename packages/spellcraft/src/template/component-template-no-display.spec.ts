...
import { IZComponentTemplate, ZComponentRenderTemplate } from '../render/component-render-template.mjs';
...
describe('ZComponentTemplateNoDisplay', () => {
  ...
  interface ZComponentRenderWithTemplateTest extends IZComponentTemplate, IZComponentRender {}
